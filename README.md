...
As explained by the author of this website, custom sound settings (patches) shared by users on Voxamps.com were removed in 2013.
However, he succeeded in retrieving some files thanks to the [Wayback Machine](https://web.archive.org/), and created a Excel macro file out of them.
